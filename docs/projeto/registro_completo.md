...
Este arquivo preserva o registro historico e operacional completo do projeto. O README da raiz foi reduzido para servir como porta de entrada sintetica do repositorio.
